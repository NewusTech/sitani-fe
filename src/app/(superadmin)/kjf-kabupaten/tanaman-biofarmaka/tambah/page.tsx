...
const TambahTanamanBiofarmaka = () => {
    ...
    const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
        ...
        try {
            ...
            console.log(data)
            console.log("Failed to create Tanaman Biofarmaka:");
            return;
        } finally {
        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="">
                ...
                <div className="mb-10 flex justify-end gap-3">
                    <Link href="/kjf-kabupaten/tanaman-biofarmaka" className='bg-white w-[120px] rounded-full text-primary hover:bg-slate-50 p-2 border border-primary text-center font-medium transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110duration-300'>
                        Batal
                    </Link>
