...
const PenyuluhDataKabupaten = () => {
    ...
    return (
        <div>
            {/* title */}
            <div className="md:text-2xl text-xl mb-5 font-semibold text-primary">Daftar Penempatan Penyuluh Pertanian Kabupaten</div>
            {/* title */}
                    ...
                    dataKabupaten.data.data.map((item, index) => (
                        <div key={index} className="card-table text-[12px] p-4 rounded-2xl border border-primary bg-white shadow-sm">
                            <div className="wrap-konten flex flex-col gap-2">
                                ...
                                <div className="flex justify-between gap-5">
                                    <div className="label font-medium text-black">Wilayah Desa Binaan (Kecamatan)</div>
                                    <div className="konten text-black/80 text-end">
                            ...
                            <div className="flex gap-3 text-white">
                                <Link href={`/penyuluhan/data-kabupaten/detail/${item.id}`} className="bg-primary rounded-full w-full py-2 text-center">
                                    Detail
                                </Link>
                                <Link href={`/penyuluhan/data-kabupaten/edit/${item.id}`} className="bg-yellow-400 rounded-full w-full py-2 text-center">
                                    Edit
                                </Link>
