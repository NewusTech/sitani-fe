...
const TambahTanamanBiofarmaka = () => {
    ...
    const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
        ...
        try {
            ...
            console.log(data)
            // push
            navigate.push('/tanaman-pangan-holtikutura/validasi/tanaman-biofarmaka');
        ...
        <>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="">
                ...
                <div className="mb-10 flex justify-end gap-3">
                    <Link href="/tanaman-pangan-holtikutura/validasi/tanaman-hias" className='bg-white w-[120px] rounded-full text-primary hover:bg-slate-50 p-2 border border-primary text-center font-medium transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110duration-300'>
                        Batal
                    </Link>
