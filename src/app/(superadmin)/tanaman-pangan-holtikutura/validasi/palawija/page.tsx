...
const ValidasiPalawija = () => {
    ...
    return (
        <div>
            {/* title */}
            <div className="text-2xl mb-5 font-semibold text-primary uppercase">Validasi Palawija</div>
            {/* title */}
