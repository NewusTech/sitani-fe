...
const KorlubSayuranBuah = () => {
    ...
    return (
        <div>
            {/* title */}
            <div className="text-2xl mb-5 font-semibold text-primary uppercase">Korluh Sayuran dan Buah</div>
            {/* title */}
            ...
            <div className="lg:flex gap-2 lg:justify-between lg:items-center w-full mt-2 lg:mt-4">
                ...
                <div className="w-full mt-2 lg:mt-0 flex justify-end gap-2">
                    ...
                    <Link href="/korluh/sayuran-buah/tambah" className='bg-primary px-3 py-3 rounded-full text-white hover:bg-primary/80 p-2 border border-primary text-center font-medium text-[12px] lg:text-sm w-[180px]'>
                        Tambah Data
                    </Link>
                </div>
            </div>
