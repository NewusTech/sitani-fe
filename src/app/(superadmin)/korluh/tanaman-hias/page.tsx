    ...
    return (
        <div>
            ...
            <div className="mobile  block md:hidden sm:hidden lg:hidden">
                ...
                {/* <KorluhTanamanHiasMobile urlApi={`korluh/tanaman-hias/get?page=${currentPage}&search=${search}&limit=${limit}&kecamatan=${selectedKecamatan}&startDate=${filterStartDate}&endDate=${filterEndDate}`} /> */}
            </div>
            {/*table mobile */}
