    ...
    return (
        <div>
            ...
            <div className="mb-4 flex justify-start gap-2 md:gap-3 mt-4">
                <Link href="/korluh/tanaman-hias" className='bg-white w-[120px] rounded-full text-primary hover:bg-slate-50 p-2 border border-primary text-center font-medium transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110duration-300 text-xs md:text-sm'>
                    Kembali
                </Link>
            </div>
            ...
            <div className="wrap-table md:hidden">
                <div className="wrap-detail bg-slate-100 p-5 md:p-6 md:mt-5 lg:mt-3 rounded-lg">
                    <div className="font-semibold mb-2 text-sm md:text-base text-center">Detail Data Tanaman Hias</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
                        ...
                        <hr className="border border-primary-600 transition-all ease-in-out animate-pulse" />
                        <LabelDetail label="Satuan Produksi" value={data?.satuanProduksi} />
                        <hr className="border border-primary-600 transition-all ease-in-out animate-pulse" />
