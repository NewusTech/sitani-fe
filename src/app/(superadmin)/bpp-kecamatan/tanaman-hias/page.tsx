...
const KorlubTanamanHias = () => {
    ...
    const handleTolak = async (payload: { kecamatan_id: number; bulan: string; status: string; keterangan: string; }) => {
        try {
            await axiosPrivate.post("/validasi/korluh-tanaman-hias/kec", payload);
            // alert
            Swal.fire({
                icon: 'success',
        ...
        mutate(`/validasi/korluh-tanaman-hias/kec?kecamatan=${selectedKecamatan}&bulan=${tahun}/${bulan}`);
    };
        ...
        <div>
            ...
            <div className="lg:flex gap-2 lg:justify-between lg:items-center w-full mt-2 lg:mt-4">
                ...
                <div className="w-full mt-2 lg:mt-0 flex justify-end gap-2">
                    ...
                    <Link href="/bpp-kecamatan/tanaman-hias/tambah" className='bg-primary px-3 py-3 rounded-full text-white hover:bg-primary/80 p-2 border border-primary text-center font-medium text-[12px] lg:text-sm w-[150px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110duration-300 cursor-pointer'>
                        Tambah Data
                    </Link>
                </div>
            </div>
