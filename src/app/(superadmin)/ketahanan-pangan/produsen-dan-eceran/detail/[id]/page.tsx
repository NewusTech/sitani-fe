...
const DetailProdusenPage = () => {
  ...
  return (
    <div>
      {/* title */}
      <div className="text-xl md:text-2xl mb-4 font-semibold text-primary uppercase">Detail Data Produsen dan Eceran</div>
      {/* back button */}
      ...
      <div className="wrap-detail bg-slate-100 p-5 md:p-6 md:mt-5 mt-3 rounded-lg">
        <div className="font-semibold mb-2 text-base md:text-lg">Data Produsen dan Eceran</div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3">
          <LabelDetail label='Komoditas' value={data?.komoditas?.nama} />
          <LabelDetail label='Tanggal' value={formatDate(data?.createdAt) || ''} />
