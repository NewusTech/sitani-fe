...
const EdithPegawaiPage = () => {
  ...
  const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
    ...
    try {
      ...
      navigate.push('/kepegawaian/data-pensiun');
      reset();
    } catch (error) {
      Swal.fire({
        icon: 'error',
  ...
  return (
    <>
      <div className="text-primary text-xl md:text-2xl font-bold mb-5">Edit Data Pensiun</div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="">
        ...
        <div className="mb-10 flex justify-end gap-3">
          <Link href="/kepegawaian/data-pensiun" className='bg-white w-[120px] text-xs md:text-sm  rounded-full text-primary hover:bg-slate-50 p-2 border border-primary text-center font-medium flex justify-center items-center transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110duration-300'>
            Batal
          </Link>
