...
const PSPBantuan = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/psp-bantuan?kecamatan=${props.kecamatan}&startDate=${props.startDate}&endDate=${props.endDate}`;
        ...
        try {
            ...
            link.setAttribute('download', `Data Bantuan Kabupaten Lampung Timur.xlsx`); // Nama file yang diunduh
    ...
    const handleDownloadPDF = async () => {
        try {
            if (printRef.current) {
                ...
                pdf.save(`Data Bantuan Kabupaten Lampung Timur.pdf`);
        ...
        <div className="">
            ...
            <div className="absolute -left-full w-full">
                ...
                <div ref={printRef} className='p-[50px]'>
                    {/* title */}
                    <div className="text-xl mb-4 font-semibold text-black mx-auto uppercase flex justify-center items-center flex-col">
                        Data Bantuan Kabupaten Lampung Timur Tahun {currentYear} <br />
                        {props.startDate && props.endDate ? (
                            <div className="flex justify-center text-center">
                                Periode {props.startDate} - {props.endDate}
                            </div>
                        ) : null}
                    </div>
                    {/* title */}
                    ...
                    <Table className='border border-black p-2 mt-1'>
                        <TableHeader className='bg-white text-black'>
                            <TableRow >
                                ...
                                <TableHead className="border border-black p-2 text-black uppercase text-center font-semibold">Desa</TableHead>
                                <TableHead className="border border-black p-2 text-black uppercase text-center font-semibold ">Jenis Bantuan</TableHead>
                                <TableHead className="border border-black p-2 text-black uppercase text-center font-semibold ">Periode</TableHead>
