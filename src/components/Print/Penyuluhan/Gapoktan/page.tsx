...
const PenyuluhGapoktan = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/penyuluh-gabungan-kelompok-tani?year=${props.tahun}`;
...
export default PenyuluhGapoktan