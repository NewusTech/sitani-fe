...
const KorluhHias = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/korluh-hias?year=${props.tahun}&kecamatan=${props.kecamatan}&triwulan=${props.triwulan}}`;
