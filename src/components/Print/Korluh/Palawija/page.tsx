...
const KorluhPalawija = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/korluh-palawija?&kecamatan=${props.kecamatan}&bulan=${props.bulan}`;
