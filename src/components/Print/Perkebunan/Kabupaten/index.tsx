...
const PerkebunanKabupatenPrint = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        ...
        try {
            ...
            link.setAttribute('download', 'Perkebunan Kabupaten.xlsx'); // Nama file yang diunduh
...
export default PerkebunanKabupatenPrint