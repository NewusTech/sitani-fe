...
const KecamatanKorluhPadiPrint = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/korluh-padi?kecamatan=${props.kecamatan}&bulan=${props.tahun}/${props.bulan}`;
        try {
            ...
            link.setAttribute('download', `BPP Kecamatan Padi Kabupaten Lampung Timur.xlsx`); // Nama file yang diunduh
...
export default KecamatanKorluhPadiPrint