...
const KecamatanKorluhSayurBuahPrint = (props: PrintProps) => {
    ...
    const handleDownloadExcel = async () => {
        const url = `${process.env.NEXT_PUBLIC_BACKEND_URL}/api/download/korluh-sayur-buah?kecamatan=${props.kecamatan}&bulan=${props.tahun}/${props.bulan}`;
        try {
            ...
            link.setAttribute('download', `BPP Kecamatan Sayur Buah Kabupaten Lampung Timur.xlsx`); // Nama file yang diunduh
...
export default KecamatanKorluhSayurBuahPrint