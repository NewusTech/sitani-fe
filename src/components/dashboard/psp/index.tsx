...
const DashboardPSP = () => {
    return (
        <section className="space-y-2 lg:space-y-4">
            <div className="text-lg lg:text-xl font-semibold text-primary uppercase lg:text-left text-center">Dashboard PSP</div>
