...
const BerandaIcon = () => {
    ...
    return (
        <>
            <svg className={`${pathname === "/" || pathname.startsWith("/beranda") ? "stroke-primary" : "stroke-black"}`} width="22" height="25" viewBox="0 0 22 25" fill="none" xmlns="http://www.w3.org/2000/svg">
