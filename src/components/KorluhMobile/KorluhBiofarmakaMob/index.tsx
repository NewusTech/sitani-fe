...
const KorluhBiofarMobile = ({ urlApi }: KorluhRespon) => {
    // Format date
    ...
    const tableDataTanaman: Array<Record<string, React.ReactNode>> = dataTanamanBioFarmaka?.data?.data.flatMap((item) =>
        item.list.map((tanaman) => ({
            ...
            aksi: (
                <div className="flex gap-4 items-center mt-2">
                    <Link title="Detail" href={`/bpp-kecamatan/tanaman-biofarmaka/detail/${tanaman.id}`}>
                        <EyeIcon />
                    </Link>
                    <Link title="Edit" href={`/bpp-kecamatan/tanaman-biofarmaka/edit/${tanaman.id}`}>
                        <EditIcon />
                    </Link>
    ...
    return (
        <div className="">
            ...
            <div className="wrap-table flex flex-col gap-1">
                <div className="font-semibold mb-2">Tanaman Biofarmaka</div>
...
export default KorluhBiofarMobile;
